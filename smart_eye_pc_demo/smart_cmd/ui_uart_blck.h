...
public:
    ...
    void retranslateUi(QWidget *uart_blck)
    {
        ...
        label_2->setText(QApplication::translate("uart_blck", "<html><head/><body><p><span style=\" font-size:22pt;\">\344\270\262\345\217\243\351\205\215\347\275\256</span></p></body></html>", nullptr));
