...
public:
    ...
    void setupUi(QWidget *file_mdle)
    {
        ...
        label_8 = new QLabel(file_mdle);
        label_8->setObjectName(QString::fromUtf8("label_8"));

        horizontalLayout_10->addWidget(label_8);

        ui_cmd_file = new QLineEdit(file_mdle);
        ui_cmd_file->setObjectName(QString::fromUtf8("ui_cmd_file"));

        horizontalLayout_10->addWidget(ui_cmd_file);
        ...
        ui_write_reset = new QPushButton(file_mdle);
        ui_write_reset->setObjectName(QString::fromUtf8("ui_write_reset"));

        horizontalLayout->addWidget(ui_write_reset);
    ...
    void retranslateUi(QWidget *file_mdle)
    {
        ...
        ui_write_reset->setText(QApplication::translate("file_mdle", "\345\244\215\344\275\215", nullptr));
