...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set index [ipgui::add_page $IPINST -name "index"]
  ipgui::add_static_text $IPINST -name "note" -parent ${index} -text {s_shk_0_valid
s_shk_0_msync: write sync
s_shk_0_mdata:write data
s_shk_0_mdat1:read number
s_shk_0_maddr:write or read data
s_shk_0_ready: write or read ready
s_shk_0_ssync:read data sync
s_shk_0_sdata: read data val
s_shk_0_saddr:read addr}
