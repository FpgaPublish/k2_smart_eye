...
module bram_to_shk #(
    ...
    input           s_info_wr_frm1, //frame start signal
    input           s_info_wr_frm2, //frame start 2
    input           s_info_wr_frm3, //frame start 3
    //bram matser
...
reg [WD_SHK_ADDR-1:0]  r_shk_dst_maddr;
//========================================================
...
always@(posedge i_sys_clk)
begin
    if(s_info_wr_frm1) //state IDLE reset
    begin
        r_shk_dst_maddr <= NB_DDR_INI1;
    end
    else if(s_info_wr_frm2)
    begin
        r_shk_dst_maddr <= NB_DDR_INI2;
    end
    else if(s_info_wr_frm3)
    begin
        r_shk_dst_maddr <= NB_DDR_INI3;
    end
