...
localparam WD_SRC_DIV_DST = LOG(NB_SRC_DIV_DST);
//========================================================
...
reg                    r_shk_src_valid;
reg                    r_shk_src_msync;
reg [WD_SHK_DATA-1:0]  r_shk_src_mdata;
...
reg                    r_shk_dst_ssync;
reg [WD_DST_DATA-1:0]  r_shk_dst_sdata;
reg [WD_DST_ADDR-1:0]  r_shk_dst_saddr;
...
generate genvar i;
    for(i = 0; i < NB_SRC_DIV_DST - 1; i = i + 1) //just temp high 2 BYTE
...
begin
    ...
    begin
        ...
        r_bram_read_sync <= m_bram_read_dout;
    end
end
