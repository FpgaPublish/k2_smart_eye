...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "WD_BYTE_SUM"

}

proc update_PARAM_VALUE.WD_BYTE_SUM { PARAM_VALUE.WD_BYTE_SUM } {
	# Procedure called to update WD_BYTE_SUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.WD_BYTE_SUM { PARAM_VALUE.WD_BYTE_SUM } {
	# Procedure called to validate WD_BYTE_SUM
	return true
}
...
proc update_MODELPARAM_VALUE.WD_BYTE_SUM { MODELPARAM_VALUE.WD_BYTE_SUM PARAM_VALUE.WD_BYTE_SUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.WD_BYTE_SUM}] ${MODELPARAM_VALUE.WD_BYTE_SUM}
}
